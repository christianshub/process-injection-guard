...
Process-Injection-Guard is a DLL file intended to be injected into a process to detect foreign intruders. It's main purpose was to understand how Anti-Virus/Anti-Cheat worked on a basic scale.
